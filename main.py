...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', default=0.0003, type=float, help='IN, PU: 0.0003, KSC: 0.0001')
    ...
    parser.add_argument('--depth', default=32, type=int, help='IP、KSC:32 PU:8 ')
    ...
    elif args.ab_study == 'RSSAN-ALL-s':
        model = RSSAN.RSSAN_ALL_s(kinds, bands, 3, args.depth, 1, 1, args.patchsize)
    elif args.ab_study == 'RSSAN-SE-s':
        model = RSSAN.RSSAN_SE_s(kinds, bands, 3, args.depth, 1, 1, args.patchsize)
    elif args.ab_study == 'RSSAN-SA-s-wo':
